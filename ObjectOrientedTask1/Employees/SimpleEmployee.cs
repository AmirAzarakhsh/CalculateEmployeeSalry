namespace ObjectOrientedTask1.Employees
{
    ...
    {
        public SimpleEmployee(string fname, string lname, string nationalId, int level, decimal baseSalary,
            decimal totalHours, decimal extraHours, decimal employeeRatio = 1)
